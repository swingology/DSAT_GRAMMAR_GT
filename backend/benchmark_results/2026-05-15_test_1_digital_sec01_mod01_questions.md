# Benchmark: Test 1 Digital Section 01 Module 01 Questions

## Summary

- Source PDF: `/home/jb/DSAT_REDUX_MD/TESTS/DATA_SRC/2025-2026 Tests Answers/VERBAL/Test_1_digital_sec01_mod01.pdf`
- Benchmark mode: PyMuPDF embedded-text extraction + deterministic question/option parser
- OCR status: skipped; PDF contains embedded text
- LLM full-module extraction status: timed out on `deepseek-v4-pro:cloud` after repeated long requests; deterministic extraction used for this question/options report
- Pages parsed: 14
- Embedded text characters: 30244
- Embedded images detected: 14
- Parse latency: 62 ms
- Questions parsed: 33 / 33
- Questions with A-D options: 33 / 33
