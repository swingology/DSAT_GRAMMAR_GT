...
# --- Content origin ---
CONTENT_ORIGINS = (
    "official", "unofficial", "generated",
)

# --- Job types ---
JOB_TYPES = (
    "ingest", "generate", "reannotate", "overlap_check",
)
...
# --- Relation types ---
RELATION_TYPES = (
    "overlaps_official", "derived_from", "near_duplicate", "generated_from",
    "adapted_from",
)

# --- Asset types ---
ASSET_TYPES = (
    "pdf", "image", "screenshot", "markdown", "json", "text",
)

# --- Change sources ---
CHANGE_SOURCES = (
    "ingest", "generate", "admin_edit", "reprocess",
)
...
STEM_TYPE_KEYS = (
    ...
    "choose_words_in_context", "choose_word_in_context",
    "choose_cross_text_connection", "choose_text_relationship",
    "choose_agreement_across_texts", "choose_difference_across_texts",
    "choose_best_inference", "choose_command_of_evidence_textual",
    "choose_command_of_evidence_quantitative", "choose_central_detail",
    "choose_detail", "choose_best_illustration", "choose_best_weakener",
    "conform_to_standard_english", "most_logically_completes",
    "synthesize_information", "compare_contributions",
)
...
GRAMMAR_FOCUS_BY_ROLE = {
    "sentence_boundary": (
        "sentence_fragment", "comma_splice", "run_on_sentence",
        "sentence_boundary",
    ),
    "agreement": (
    ...
    "verb_form": (
        "verb_tense_consistency", "verb_form", "voice_active_passive",
        "negation",
    ),
    "modifier": (
...
DISTRACTOR_TYPE_KEYS = (
    ...
    "grammar_error", "punctuation_error", "transition_mismatch",
    "data_misread", "goal_mismatch", "partially_supported", "overstatement",
    "understatement", "rhetorical_irrelevance", "partial_match", "correct",
...
# --- Reading v2 §10 reasoning_trap_key (question-level) ---
REASONING_TRAP_KEYS = (
    ...
    "single_measure_focus", "local_maximum_trap", "same_direction_assumption",
    "absolute_value_confusion", "constraint_ignored",
    "individual_inference_from_aggregate_bins", "common_definition_trap",
    "semantic_relatedness_without_precision", "connotation_mismatch",
    "plausible_synonym", "also_true_trap", "wrong_scope", "wrong_action_verb",
    "overstated_position", "partial_purpose", "reversed_attribution",
    "extreme_language", "textual_mimicry", "confirmed_when_contradicted",
    "polarity_mismatch", "local_semantic_role_mismatch",
    "tone_register_mismatch", "rhetorical_scope_shift",
    "author_action_misclassification", "evidence_relationship_blend",
    "attribution_blend", "agreement_degree_mismatch",
    "figurative_literal_confusion", "false_concession_trap",
...
ANSWER_MECHANISM_KEYS = (
    "rule_application", "pattern_matching", "evidence_location", "inference",
    "data_synthesis", "evidence_matching", "contextual_substitution",
...
SOLVER_PATTERN_KEYS = (
    "apply_grammar_rule_directly", "locate_error_zone", "compare_register",
    "evaluate_transition", "synthesize_notes", "eliminate_by_boundary",
    "locate_claim_then_match_evidence", "read_graphic_then_match_claim",
    "summarize_then_compare", "locate_detail_directly", "identify_logical_gap",
    "substitute_and_test", "classify_rhetorical_move",
    "summarize_both_then_compare", "apply_negation_logic",
...
STUDENT_FAILURE_MODE_KEYS = (
    ...
    "surface_similarity_bias", "scope_blindness", "modifier_hitchhike",
    "chronological_assumption", "extreme_word_trap", "overreading",
    "underreading", "grammar_fit_only", "register_confusion",
    "pronoun_anchor_error", "parallel_shape_bias", "transition_assumption",
    "idiom_memory_pull", "false_precision", "negation_blindness",
    "connotation_surface_match", "local_role_misread",
    ...
    "scope_role_confusion", "author_action_overread", "attribution_swap",
    "agreement_degree_overread", "relationship_simplification",
    "polarity_blindness", "tense_proximity_pull",
    "internal_unit_punctuation_insertion", "declarative_question_confusion",
    "restrictive_appositive_comma_insertion", "title_name_comma_insertion",
    "nonfinite_for_finite", "inflected_after_modal",
    "plural_pronoun_for_clause_antecedent", "past_tense_for_literary_present",
    "transition_wrong_direction", "notes_synthesis_wrong_goal",
    "notes_synthesis_audience_mismatch", "adverb_adjective_confusion",
    "illogical_comparison_blindness", "confused_word_substitution",
    "preposition_idiom_error", "notes_synthesis_content_omission",
)
...
TENSE_REGISTER_KEYS = (
    "narrative_past", "scientific_general_present", "historical_past",
    "study_procedure_past", "established_finding_present",
    "mixed_with_explicit_shift", "literary_present",
)
...
QUESTION_FAMILY_KEYS = (
    "conventions_grammar", "expression_of_ideas", "craft_and_structure",
    "information_and_ideas",
)

# --- Reading question families (subset of QUESTION_FAMILY_KEYS) ---
...
# --- Reading v2 reading_focus_key (grouped by skill family) ---
...
TRANSITION_SUBTYPE_KEYS = (
    ...
    "change_over_time", "exception", "final_realization", "converse_opposite",
    "present_continuation", "direct_refutation", "logical_consequence",
...
SYNTHESIS_GOAL_KEYS = (
    ...
    "identify_setting", "identify_title", "identify_year", "identify_duration",
    "identify_distance", "identify_author_pseudonym",
...
SYNTHESIS_DISTRACTOR_FAILURE_KEYS = (
    ...
    "omits_unfamiliar_context", "wrong_audience_assumption",
    "misstates_required_relationship", "irrelevant_background",
)
