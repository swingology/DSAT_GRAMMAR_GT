...
REGISTRY: list[dict] = [
    ...
    {"name": "SYNTACTIC_TRAP_REQUIRED_ROLES", "kind": "flat", "domain": "grammar",
     "comment": "Grammar roles that always require a non-null syntactic_trap_key (policy subset of GRAMMAR_ROLE_KEYS)"},
    ...
    {"name": "GRAMMAR_QUESTION_FAMILY_KEYS", "kind": "flat", "domain": "grammar",
     "comment": "Grammar question families (subset of QUESTION_FAMILY_KEYS)"},
