...
(29 table rows; 28 distinct concepts — `polarity_blindness` is an approved
synonym of `negation_blindness`.)
...
| 6 | `figurative_meaning_blindness` | Words in Context |
| 7 | `exact_value_misread` | Quantitative CoE |
| 8 | `wrong_time_window` | Quantitative CoE |
| 9 | `individual_from_aggregate` | Quantitative CoE |
| 10 | `all_measures_not_checked` | Quantitative CoE |
| 11 | `wrong_comparison_direction` | Quantitative CoE |
| 12 | `wrong_group_selected` | Quantitative CoE |
| 13 | `wrong_row_column_lookup` | Quantitative CoE |
| 14 | `single_measure_overread` | Quantitative CoE |
| 15 | `local_maximum_overread` | Quantitative CoE |
| 16 | `same_direction_assumption` | Quantitative CoE |
| 17 | `absolute_value_overweighting` | Quantitative CoE |
| 18 | `constraint_ignored` | Quantitative CoE |
| 19 | `two_part_claim_partial_match` | CoE-Textual |
| 20 | `control_group_misidentification` | CoE-Textual |
| 21 | `evidence_scope_mismatch` | CoE-Textual |
| 22 | `subgroup_overgeneralization` | Inferences |
| 23 | `parenthetical_function_confusion` | Text Structure and Purpose |
| 24 | `rhetorical_verb_partial` | Text Structure and Purpose |
| 25 | `scope_role_confusion` | Text Structure and Purpose |
| 26 | `author_action_overread` | Text Structure and Purpose |
| 27 | `attribution_swap` | Cross-Text Connections |
| 28 | `agreement_degree_overread` | Cross-Text Connections |
| 29 | `relationship_simplification` | Cross-Text Connections |
