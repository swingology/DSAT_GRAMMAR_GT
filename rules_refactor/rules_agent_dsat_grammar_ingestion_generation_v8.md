...
| Generation validation checklist (checks 1–29) | B.13 |
...
*Document version: v8.2-refactor — 2026-08-02 — contradiction fixes: duplicate `logical_predication`/`comparative_structures` entries merged, invalid enum values in B.4/B.12 corrected, `absolute_phrase` added to D.8.1, D.8.3 frequency bands completed for all 44 focus keys, check/section counts corrected, C.7→C.5 amendment references fixed, `affirmative_agreement`/`negation` marked annotation-only*
*Previous: v8.1 — 2026-06-21 — D.10 added: sentence anatomy keys for span annotation*
...
*Companion file: `rules_agent_dsat_reading_v3.md`*
